...
6. Run `analyze_quality.py` and inspect `missions/nero/mission2/quality/index.html` for completeness, timing, trajectory, hand, video, and date-distribution issues.
