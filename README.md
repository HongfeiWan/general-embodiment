...
示例：检查 smooth 数据中某个来源日期批次，并输出 HTML/CSV/JSON 报告到 `missions/nero/mission2/batch_quality/`：

```bash
python3 tools/data_chain/check_lerobot_batch_quality.py --dataset-dir missions/nero/mission2/smooth --date 2026-06-23 --date-field source
```
